...
uint8_t ADC_Init(void)
{
	...
	ADC0->CFG1 = ADC_CFG1_ADICLK(ADICLK_BUS_2) | ADC_CFG1_ADIV(ADIV_4) | ADC_CFG1_ADLSMP_MASK;	// // Zegar wejsciowy BUS/2=10.49MHz, zegar ADCK równy 2.62MHz (2621440Hz), dlugi czas prókowania
	ADC0->CFG2 = ADC_CFG2_ADHSC_MASK;										// Wlacz wspomaganie zegara o duzej czestotliwosci
	ADC0->SC3  = ADC_SC3_AVGE_MASK | ADC_SC3_AVGS(3);		// Wlacz usrednianie na 32 próbki
	...
	if(ADC0->SC3 & ADC_SC3_CALF_MASK)
{
	...
	ADC0->CFG1 = ADC_CFG1_ADICLK(ADICLK_BUS_2) | ADC_CFG1_ADIV(ADIV_1) | ADC_CFG1_ADLSMP_MASK | ADC_CFG1_MODE(MODE_12);	// Zegar ADCK równy 10.49MHz, rozdzielczosc 12 bitów, dlugi czas próbkowania
	...
	return(0);																	// Wróc, jesli wszystko w porzadku
}
